...
public class HomePage extends HelperFunctions {
	...
	public void setImage(ExtentTest test) throws Exception {
   	 ...
   	 for (WebElement element2 : productDropdownList) {
   	     if (element2.isDisplayed() && element2.isEnabled()) {
   	         ...
   	         if (elementText != null && !elementText.isEmpty()) {
   	             ...
   	             for (String cellValue : cellValues2) {
   	                 if (cellValue.equalsIgnoreCase(elementText)) {
   	                     elementFound = true;
   	                     break;
   	                 }
   	             }
   	             Assert.assertTrue(elementFound, "element text: " + elementText + " not found in the column: " + columnIndex2);
   	         } else {
   	             System.out.println("Element text is empty or null, skipping the element");
   	         }
   	     } else {
       ...
       /*  HashSet<String> cellValues3 = new HashSet<String>();
    	 ...
    	 for (WebElement element3 : catDropdownList) {
    	     ...
    	     if (element3.isDisplayed() && element3.isEnabled()) {
    	         ...
    	         if (elementText2 != null && !elementText2.isEmpty()) {
    	             boolean elementFound = false;
    	             for (String cellValue : cellValues3) {
    	                 if (cellValue.equalsIgnoreCase(elementText2)) {
    	                     elementFound = true;
    	                     break;
    	                 }
    	             }
    	             Assert.assertTrue(elementFound, "element text: " + elementText2 + " not found in the column: " + columnIndex3);
    	         } else {
    	             System.out.println("Element text is empty or null, skipping the element");
    	         }
    	     } else {
